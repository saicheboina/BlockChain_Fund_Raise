...
import { Component } from "@/components/common/Chart";
          ...
          <Card x-chunk="dashboard-01-chunk-4">
            <CardHeader className="flex flex-row items-center">
              <div className="grid gap-2">
                ...
                <CardDescription>
                  Recent transactions from all Campaigns.
                </CardDescription>
              </div>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {allTransactions.slice(-5).map((trans) => (
                    <TableRow key={trans.transactionId}>
                      <TableCell>
                        <div className="font-medium">{trans.name}</div>
                      </TableCell>
                      <TableCell>
                        <div className="font-medium">{trans.email}</div>
                      </TableCell>
                      <TableCell>
                        <div className="font-medium">
                          {dayjs(trans.date).fromNow()}
                        </div>
                      </TableCell>
                      <TableCell>
